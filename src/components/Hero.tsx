    ...
    <section id="top" className="relative overflow-hidden pt-28 sm:pt-32">
      ...
      <div className="container-page relative">
        ...
        <div className="mx-auto max-w-[1000px] text-center">
          <p className="eyebrow mb-6 inline-block">The visual AI workflow platform</p>
          <h1 className="font-display text-hero text-balance text-ink">
            BUILD AI<br />
            <span className="text-accent">SYSTEMS</span> VISUALLY
          </h1>
          <p className="mx-auto mt-7 max-w-prose text-balance text-[17px] leading-relaxed text-muted sm:text-lg">
            Design, connect, and govern AI agents, tools, and business workflows in one
            visual environment. Not another chatbot — a workspace where you compose
            systems like node-based programming, then run them.
          </p>
